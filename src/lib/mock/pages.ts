...
export const pages: CmsPage[] = [
  ...
  },
  {
    ...
    name: 'Бидний тухай',
    slug: 'about',
    description: 'Huajiuan Allinium компанийн танилцуулга, туршлага, EOSS албан ёсны хэрэглэгч',
    content:
      '<p>Huajiuan Allinium нь 4 жилийн туршлагатай, барилгын салбарт шилэн пасад, металл пасад, барилгын гадна дуулаалга, дагалдах хэрэгсэл тоноглолын худалдаа болон угсралтын үйлчилгээ үзүүлдэг мэргэжлийн компани юм.</p>\n' +
      '<p>Бид Хятадын Huajian Aluminium компанийн EOSS брендийн албан ёсны хэрэглэгч бөгөөд Монгол улсад тус брендийн шилэн пасадын бүтээгдэхүүнийг албан ёсоор нэвтрүүлж, борлуулж, угсарч байна. EOSS систем нь Passive House сертификаттай, Монголын хатуу уур амьсгалд тохируулсан, эрчим хүчний хэмнэлттэй шийдэл юм.</p>\n' +
  ...
  },
  {
    ...
    content:
      ...
      '<p>Huajian Aluminium-ийн EOSS бренд нь Passive House сертификаттай, өндөр чанарын шилен пасадын систем юм. Schüco-той ижил төрлийн үйл ажиллагаа явуулдаг бөгөөд олон улсын стандарт, Passive House шаардлагыг хангасан ч үнийн хувьд арай оновчтой.</p>\n' +
