...
export const menus: CmsMenuItem[] = [
  ...
  { _id: 'header-5', labelKey: 'gallery', url: '/gallery', order: 5, kind: 'header' },
  { _id: 'header-6', labelKey: 'blog', url: '/blog', order: 6, kind: 'header' },
  { _id: 'header-7', labelKey: 'contact', url: '/contact', order: 7, kind: 'header' },
  ...
  { _id: 'footer-5', labelKey: 'gallery', url: '/gallery', order: 5, kind: 'footer' },
  { _id: 'footer-6', labelKey: 'blog', url: '/blog', order: 6, kind: 'footer' },
  { _id: 'footer-7', labelKey: 'contact', url: '/contact', order: 7, kind: 'footer' },
];
